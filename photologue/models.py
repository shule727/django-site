...
class Gallery(models.Model):
    date_added = models.DateField(_('date published'),
                                      default=now)
...
class ImageModel(models.Model):
    ...
    date_taken = models.DateField(_('date taken'),
                                      null=True,
                                      blank=True,
    ...
    def save(self, *args, **kwargs):
        ...
        if self.date_taken is None or image_has_changed:
            ...
            try:
                exif_date = self.EXIF(self.image.file).get('EXIF DateOriginal', None)
                ...
                logger.error('Failed to read EXIF DateOriginal', exc_info=True)
